...
document.querySelector("#mary .info").textContent = mary.toString();
document.querySelector("#jane .img").src = jane.avatar;
document.querySelector("#jane .info").textContent = jane.toString();
...
// b. Tampilkan info dengan Template literals
charlesJobInfoSelector.innerHTML = ` ${fullName} job is ${job}`;